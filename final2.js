...
function coffeeDrink() {
  ...
  var coffee = [crepes, deja, brew, liquid];
  var names4="";
  for (var x=0; x<coffee.length;x++){
      names4 = names4 + "<ul>" + coffee[x].name + "</ul>" + "<li>" + coffee[x].address + "</li>";
  }
...
function smoothieDrink() {
  ...
  for (var x=0; x<smoothies.length;x++){
      names5 = names5 + "<ul>" + smoothies[x].name + "</ul>" + "<li>" + smoothies[x].address + "</li>";
  }
...
function boozeDrink() {
  ...
  for (var x=0; x<booze.length;x++){
      names6 = names6 + "<ul>" + booze[x].name + "</ul>" + "<li>" + booze[x].address + "</li>";
  }
